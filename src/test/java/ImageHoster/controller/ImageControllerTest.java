...
public class ImageControllerTest {
    ...
    // This test checks the controller logic to get all the images after the user is logged in the application
    // and checks whether the logic returns the html file 'images.html'
    @Test
    ...
    // to get the details of a particular image and checks whether the logic returns the html file 'images/image.html'
    @Test
    ...
    // to get the form to upload an image in the application and checks whether the logic returns the html file 'images/upload.html'
    @Test
    ...
    // This test checks the controller logic when the owner of the image sends the GET request
    // to get the form to edit the image and checks whether the logic returns the html file 'images/edit.html'
    @Test
    ...
    // to get the form to edit the image and checks whether the Model type object contains the desired attribute with desired value
    @Test
    ...
    // This test checks the controller logic when the owner of the image sends the DELETE request to delete the image
    // and checks whether the logic returns the html file 'images.html'
    @Test
    ...
    // This test checks the controller logic when non owner of the image sends the DELETE request to delete the image
    // and checks whether the Model type object contains the desired attribute with desired value
    @Test
