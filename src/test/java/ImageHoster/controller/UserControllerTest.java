...
public class UserControllerTest {
    ...
    // and checks whether the logic returns the html file 'users/registration.html'
    @Test
    ...
    // This test checks the controller logic for user signup when user fills the form
    // and send the POST request to the server but the password type is wrong
    ...
    // This test checks the controller logic for user signup when user fills the form
    // and send the POST request to the server with the correct password type
    ...
    // where he can enter the username and password and checks whether the logic returns the html file 'users/login.html'
    @Test
    ...
    // This test checks the controller logic for user signin when user enters the username and password
    // that has not been registered and sends the POST request to the server
    // and checks whether the logic returns the html file 'users/login.html'
    @Test
    ...
    // This test checks the controller logic for user signin when user enters the username and password
    // that has been registered and sends the POST request to the server
    // and checks whether the logic redirects to the request handling method with request mapping of type "/images"
    ...
    // This test checks the controller logic for user signout where he sends the POST request to the server
    // to invalidate the session and checks whether the logic returns the html file 'index.html'
    @Test
